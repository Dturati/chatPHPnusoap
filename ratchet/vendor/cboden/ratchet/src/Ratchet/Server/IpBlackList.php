...
class IpBlackList implements MessageComponentInterface {
    ...
    /**
     * Add an address to the blacklist that will not be allowed to connect to your acl
     * @param  string $ip IP address to block from connecting to your acl
     * @return IpBlackList
     */
    ...
    /**
     * Unblock an address so they can access your acl again
     * @param string $ip IP address to unblock from connecting to your acl
     * @return IpBlackList
     */
