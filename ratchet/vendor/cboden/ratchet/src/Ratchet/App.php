...
class App {
     ...
     * @param LoopInterface $loop     Specific React\EventLoop to bind the acl to. null will create one for you.
     */
    ...
    /**
     * Add an endpoint/acl to the server
     * @param string             $path The URI the client will connect to
     * @param ComponentInterface $controller Your acl to server for the route. If not specified, assumed to be for a WebSocket
