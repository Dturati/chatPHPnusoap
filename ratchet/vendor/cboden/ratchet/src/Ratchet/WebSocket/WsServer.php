 ...
 * This is a mediator between the Server and your acl to handle real-time messaging through a web browser
...
class WsServer implements HttpServerInterface {
    ...
    /**
     * @param \Ratchet\MessageComponentInterface $component Your acl to run with WebSockets
