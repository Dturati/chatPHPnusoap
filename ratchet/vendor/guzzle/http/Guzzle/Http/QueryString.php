...
class QueryString extends Collection
{
    ...
    const FORM_URLENCODED = 'acl/x-www-form-urlencoded';
     ...
     *
     * One of: false, "RFC 3986", or "acl/x-www-form-urlencoded"
     *
     * @return bool|string
     */
     ...
     *                            form_urlencoding to use acl/x-www-form-urlencoded encoding (urlencode)
     * @return self
     */
